...
**🇺🇸 English** · [🇫🇷 Français](README.fr.md) · [🇧🇷 Português](README.pt.md) · [🇪🇸 Español](README.es.md) · [🇻🇳 Tiếng Việt](README.vi.md) · [🇨🇳 简体中文](README.zh-cn.md) · [🇹🇼 繁體中文](README.zh-tw.md) · [🇯🇵 日本語](README.ja.md) · [🇰🇷 한국어](README.ko.md)
...
- **EN / FR / PT / ES / VN / 简体中文 / 繁體中文 / JA / 한국어 language toggle** — a runtime text-swap layer translates on-screen copy between English, French, Portuguese, Spanish, Vietnamese, Simplified Chinese, Traditional Chinese, Japanese, and Korean without reloading; the selected language persists across visits.
