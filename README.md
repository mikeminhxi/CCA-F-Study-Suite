...
**🇺🇸 English** · [🇫🇷 Français](README.fr.md) · [🇩🇪 Deutsch](README.de.md) · [🇧🇷 Português](README.pt.md) · [🇪🇸 Español](README.es.md) · [🇻🇳 Tiếng Việt](README.vi.md) · [🇨🇳 简体中文](README.zh-cn.md) · [🇹🇼 繁體中文](README.zh-tw.md) · [🇯🇵 日本語](README.ja.md) · [🇰🇷 한국어](README.ko.md) · [🇮🇳 हिन्दी](README.hi.md)
...
- **EN / FR / DE / PT / ES / VN / 简体中文 / 繁體中文 / JA / 한국어 / HI language toggle** — a runtime text-swap layer translates on-screen copy between English, French, German, Portuguese, Spanish, Vietnamese, Simplified Chinese, Traditional Chinese, Japanese, Korean, and Hindi without reloading; the selected language persists across visits.
