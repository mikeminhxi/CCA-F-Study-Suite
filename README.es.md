...
- **Selector de idioma EN / FR / DE / ID / IT / MS / PL / PT / ES / VN / 简体中文 / 繁體中文 / JA / 한국어 / HI / RU** — una capa de reemplazo de texto en tiempo de ejecución traduce el contenido en pantalla entre inglés, francés, alemán, indonesio, italiano, malayo, polaco, portugués, español, vietnamita, chino simplificado, chino tradicional, japonés, coreano, hindi y ruso, sin necesidad de recargar; el idioma elegido se mantiene en visitas futuras.
