...
[🇺🇸 English](README.md) · [🇫🇷 Français](README.fr.md) · [🇩🇪 Deutsch](README.de.md) · [🇮🇩 Bahasa Indonesia](README.id.md) · [🇮🇹 Italiano](README.it.md) · [🇧🇷 Português](README.pt.md) · [🇪🇸 Español](README.es.md) · [🇻🇳 Tiếng Việt](README.vi.md) · [🇨🇳 简体中文](README.zh-cn.md) · [🇹🇼 繁體中文](README.zh-tw.md) · [🇯🇵 日本語](README.ja.md) · [🇰🇷 한국어](README.ko.md) · **🇮🇳 हिन्दी** · [🇷🇺 Русский](README.ru.md)
...
- **EN / FR / DE / ID / IT / PT / ES / VN / 简体中文 / 繁體中文 / JA / 한국어 / HI / RU भाषा टॉगल** — एक runtime text-swap layer, पेज को दोबारा लोड किए बिना, ऑन-स्क्रीन कॉपी को अंग्रेज़ी, फ़्रेंच, जर्मन, इंडोनेशियाई, इतालवी, पुर्तगाली, स्पेनिश, वियतनामी, सरलीकृत चीनी, पारंपरिक चीनी, जापानी, कोरियाई, हिंदी और रूसी के बीच translate करता है; चुनी गई भाषा आगामी visits में भी बनी रहती है।
