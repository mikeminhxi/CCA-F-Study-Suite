...
[🇺🇸 English](README.md) · [🇫🇷 Français](README.fr.md) · [🇧🇷 Português](README.pt.md) · [🇪🇸 Español](README.es.md) · [🇻🇳 Tiếng Việt](README.vi.md) · [🇨🇳 简体中文](README.zh-cn.md) · [🇹🇼 繁體中文](README.zh-tw.md) · [🇯🇵 日本語](README.ja.md) · **🇰🇷 한국어**
...
- **EN / FR / PT / ES / VN / 简体中文 / 繁體中文 / JA / 한국어 언어 전환** — 런타임 텍스트 교체 레이어가 새로고침 없이 화면 문구를 영어, 프랑스어, 포르투갈어, 스페인어, 베트남어, 간체 중국어, 번체 중국어, 일본어, 한국어 사이에서 전환합니다. 선택한 언어는 다음 방문 시에도 유지됩니다.
