...
[🇺🇸 English](README.md) · [🇫🇷 Français](README.fr.md) · **🇧🇷 Português** · [🇪🇸 Español](README.es.md) · [🇻🇳 Tiếng Việt](README.vi.md) · [🇨🇳 简体中文](README.zh-cn.md) · [🇹🇼 繁體中文](README.zh-tw.md) · [🇯🇵 日本語](README.ja.md) · [🇰🇷 한국어](README.ko.md)
...
- **Seletor de idioma EN / FR / PT / ES / VN / 简体中文 / 繁體中文 / JA / 한국어** — uma camada de troca de texto em tempo real traduz o conteúdo na tela entre inglês, francês, português, espanhol, vietnamita, chinês simplificado, chinês tradicional, japonês e coreano sem recarregar a página; o idioma escolhido persiste entre visitas.
