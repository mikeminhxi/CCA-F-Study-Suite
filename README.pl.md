...
- **Przełącznik języka EN / FR / DE / ID / IT / MS / PL / PT / ES / VN / 简体中文 / 繁體中文 / JA / 한국어 / HI / RU** — warstwa podmiany tekstu w czasie działania tłumaczy widoczną na ekranie treść między angielskim, francuskim, niemieckim, indonezyjskim, włoskim, malajskim, polskim, portugalskim, hiszpańskim, wietnamskim, chińskim uproszczonym, chińskim tradycyjnym, japońskim, koreańskim, hindi i rosyjskim bez przeładowania strony; wybrany język jest zapamiętywany przy kolejnych wizytach.
