...
- **Przełącznik języka EN / NL / FR / DE / ID / IT / MS / PL / PT / ES / VN / ZH / TW / JA / KO / HI / RU / UK / TH** — warstwa podmiany tekstu w czasie działania tłumaczy widoczną na ekranie treść między angielskim, niderlandzkim, francuskim, niemieckim, indonezyjskim, włoskim, malajskim, polskim, portugalskim, hiszpańskim, wietnamskim, chińskim uproszczonym, chińskim tradycyjnym, japońskim, koreańskim, hindi, rosyjskim, ukraińskim i tajskim bez przeładowania strony; wybrany język jest zapamiętywany przy kolejnych wizytach.
