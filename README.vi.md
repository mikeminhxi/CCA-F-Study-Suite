...
[🇺🇸 English](README.md) · [🇫🇷 Français](README.fr.md) · [🇩🇪 Deutsch](README.de.md) · [🇧🇷 Português](README.pt.md) · [🇪🇸 Español](README.es.md) · **🇻🇳 Tiếng Việt** · [🇨🇳 简体中文](README.zh-cn.md) · [🇹🇼 繁體中文](README.zh-tw.md) · [🇯🇵 日本語](README.ja.md) · [🇰🇷 한국어](README.ko.md)
...
- **Chuyển đổi ngôn ngữ EN / FR / DE / PT / ES / VN / 简体中文 / 繁體中文 / JA / 한국어** — lớp dịch runtime thay thế nội dung hiển thị giữa tiếng Anh, tiếng Pháp, tiếng Đức, tiếng Bồ Đào Nha, tiếng Tây Ban Nha, tiếng Việt, tiếng Trung giản thể, tiếng Trung phồn thể, tiếng Nhật và tiếng Hàn mà không cần tải lại trang; ngôn ngữ đã chọn được ghi nhớ cho lần truy cập sau.
